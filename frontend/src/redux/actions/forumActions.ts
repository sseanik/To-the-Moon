...
const forumActions = {
  ...
  downvoteChild: (payload: CommentIDPayload): any => async (
    ...
    try {
      await forumAPI.downvoteComment(parentID!, commentID);
  ...
  removeUpvoteChild: (payload: CommentIDPayload): any => async (
    ...
    try {
      await forumAPI.upvoteComment(parentID!, commentID, true);
  ...
  removeDownvoteChild: (payload: CommentIDPayload): any => async (
    ...
    try {
      await forumAPI.downvoteComment(parentID!, commentID, true);
